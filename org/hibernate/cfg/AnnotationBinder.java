...
public final class AnnotationBinder {
	...
	public static void bindClass(
		...
		if ( clazzToProcess.isAnnotationPresent( jakarta.persistence.Table.class ) ) {
			jakarta.persistence.Table tabAnn = clazzToProcess.getAnnotation( jakarta.persistence.Table.class );
			table = tabAnn.name();
	...
	private static SharedCacheMode determineSharedCacheMode(Mappings mappings) {
		...
		final Object value = mappings.getConfigurationProperties().get( "jakarta.persistence.sharedCache.mode" );
		if ( value == null ) {
			LOG.debug( "No value specified for 'jakarta.persistence.sharedCache.mode'; using UNSPECIFIED" );
	...
	private static void processElementAnnotations(
		...
		if ( property.isAnnotationPresent( Version.class ) ) {
			...
			if ( property.isAnnotationPresent( ManyToOne.class ) ) {
				...
				jakarta.persistence.OrderBy ejb3OrderByAnn = property.getAnnotation( jakarta.persistence.OrderBy.class );
