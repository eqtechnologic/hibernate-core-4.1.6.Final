 ...
 * 
 */
@Generated(value = "org.jboss.logging.processor.model.MessageLoggerImplementor", date = "2012-08-08T13:37:57-0400")
    ...
    implements Serializable, CoreMessageLogger, BasicLogger
{
    ...
    private final static String missingEntityAnnotation = "Class annotated @org.hibernate.annotations.Entity but not jakarta.persistence.Entity (most likely a user error): %s";
    ...
    @Override
    public final void synchronizationFailed(final jakarta.transaction.Synchronization synchronization, final Throwable t) {
    ...
    @Override
    public final void synchronizationAlreadyRegistered(final jakarta.transaction.Synchronization synchronization) {
