 ...
 * <p/>
 * Additionally, this strategy does *not* attempt to access or use the {@link jakarta.transaction.UserTransaction} since
 * in the actual case CMT access to the {@link jakarta.transaction.UserTransaction} is explicitly disallowed.  Instead
 * we use the JTA {@link jakarta.transaction.Transaction} object obtained from the {@link TransactionManager}
 *
 * @author Gavin King
