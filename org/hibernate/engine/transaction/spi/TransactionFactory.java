...
public interface TransactionFactory<T extends TransactionImplementor> extends Service {
	...
	/**
	 * Should we attempt to register JTA transaction {@link jakarta.transaction.Synchronization synchronizations}.
	 * <p/>
	 ...
	 * {@link jakarta.transaction.Synchronization synchronizations}; {@literal false} otherwise.
	 */
